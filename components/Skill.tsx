  ...
  return (
    <div className='group relative flex cursor-pointer'>
      <motion.img
        ...
        viewport={{once:true}}
        src={name}
        className='rounded-lg bg-color4 border border-color3 object-cover w-20 h-20 xl:w-32 xl:h-32 filter transition duration-500 ease-in-out hover:animate-pulse hover:border-4 md:w-28 md:h-28'
      />
